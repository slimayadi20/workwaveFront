...
export class CalendarService {
  ...
  addEvent(body: any) {
    return this.http.post("https://20.231.246.138:8090" + '/event', body, {
      observe: 'body',
 ...
 /* updateEvent(event: any): Observable<any> {
  ...
  updateEvent(body: any) {
    return this.http.put("https://20.231.246.138:8090" + '/event', body, {
      observe: 'body',
      headers: new HttpHeaders().append('Content-Type', 'application/json')
    });
  }
  ...
  removeEvent(id: number) {
    return this.http.delete(`https://20.231.246.138:8090/event/${id}`, {
      observe: 'body',
      headers: new HttpHeaders().append('Content-Type', 'application/json')
    });
  }
